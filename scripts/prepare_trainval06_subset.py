...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a trainval06 camera-only metadata subset and image CSV.")
    parser.add_argument("--dataset-root", type=pathlib.Path, default=NUSCENES_ROOT)
...
def main() -> None:
    ...
    print("Prepared trainval06 camera subset.")
